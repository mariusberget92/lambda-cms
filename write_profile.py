...
import os
os.makedirs(r"C:\Users\mariu\Herd\lambda-cms\resources\js\Pages\Profile", exist_ok=True)
with open(r"C:\Users\mariu\Herd\lambda-cms\resources\js\Pages\Profile\Index.vue", "w", encoding="utf-8", newline="\n") as f:
    f.write(content)
