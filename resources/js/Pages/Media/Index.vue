  ...
  <AppLayout title="Media Library">
    ...
    <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <label class="cursor-pointer rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors">
      ...
      >
        ...
        <div class="p-4 flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-2 pt-1">
            <button
              type="button"
              class="w-full rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors disabled:opacity-50"
              :disabled="saving"
              @click="saveDetail"
            >
