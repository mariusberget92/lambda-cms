      ...
      <div class="rounded-lg border bg-card p-4 space-y-4">
        ...
        <form @submit.prevent="submit" class="space-y-3">
          ...
          <button
            ...
            class="w-full rounded-md bg-primary px-3 py-1.5 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors disabled:opacity-50"
          >Add item</button>
