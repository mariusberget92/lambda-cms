  ...
  <header class="flex items-center gap-3 px-3 h-11 shrink-0 border-b border-white/10 bg-[#181825] z-10">
    ...
    <template v-if="showLoopSource">
      ...
      <div class="flex items-center gap-1.5 shrink-0">
        <span class="text-xs text-white/40">Source</span>
        <select
          :value="loopSource"
          class="bg-white/5 border border-white/10 rounded px-2 py-1 text-xs text-white/80 focus:outline-none focus:border-white/30 transition-colors"
