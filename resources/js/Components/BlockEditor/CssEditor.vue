<!-- resources/js/components/BlockEditor/CssEditor.vue -->
<!-- Thin CodeMirror 6 wrapper for CSS editing with one-dark theme -->
<script setup>
...
onMounted(() => {
  ...
  const baseTheme = EditorView.theme({
    '&': { borderRadius: '0.375rem', fontSize: '11px', minHeight: '80px' },
