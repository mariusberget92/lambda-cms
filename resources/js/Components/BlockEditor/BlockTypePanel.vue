...
const ALL_TYPES = [
  ...
  { type: 'list',          label: 'List',      icon: ListOrdered,     group: 'Content' },
  { type: 'icon',          label: 'Icon',      icon: Smile,           group: 'Content' },
...
const DEFAULT_DATA = {
  ...
  button: {
    ...
    size: 'md',
    align: 'left',
    icon: { name: null, position: 'prefix', size: '1em' },
  },
  icon: {
    name: null,
    align: 'center',
  ...
  hero: {
    ...
    subtext: 'A short description that supports your headline and invites visitors to take action.',
    align: 'center',
    size: 'md',
    minHeight: '60vh',
    paddingY: null,
    headingLevel: 1,
    buttons: [
      { label: 'Get started', url: '#', variant: 'filled',  target: '_self' },
      { label: 'Learn more',  url: '#', variant: 'outline', target: '_self' },
    ],
    bgColor: null,
    textColor: null,
    bgImage: null,
